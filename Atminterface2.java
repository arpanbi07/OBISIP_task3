...
class Atminterface2 {
        ...
        while (flag == true) {
            ...
            if (UserId.equals(userid)) {
                ...
                if (UserPin.equals(userpin)) {
                    System.out.println("Congratulations!!");
                    System.out.println("your have been successfully logged in to your account.");
                    flag = false;
                } else
    ...
    public void deposit() {
        ...
        System.out.println(depositedAmount + " Amount has been deposited in your account successfully.");
    ...
    public static void main(String[] args) {
        ...
        if (input == 1) {
            Atminterface2 user = new Atminterface2();
            user.createAccount();
